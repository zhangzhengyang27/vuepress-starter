...
webpacl可以将图片、字体也编译为js代码，Rollup只编译js代码，是一个轻量级的代码。
...
![在这里插入图片描述](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/89eb3909a9145f9e246994dc767db2f6.jpeg)

首先，我们分别通过这两种方式，创建Vue脚手架。我们来看一下两者的 main.js 有什么不一样

![在这里插入图片描述](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/myBlog/9766240e0f1342a2b395550d4815b3ec.jpeg)

区别很明显，在 Vue 实例中，runtime-compiler 创建的项目中的参数是 components 和 template，而在 runtime-only创建的项目中，参数是 render函数，这是他们最大的区别
...
结果：发布生产的时候，runtime-only构建的项目代码体积更小，运行速度更快推荐使用runtime-only函数
