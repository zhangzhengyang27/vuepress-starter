# 利用插件机制横向扩展 Webpack 的能力

Webpack 插件机制的目的是为了增强 Webpack 在项目自动化构建方面的能力。通过[上一篇文章](https://blog.zce.me/2020/04/how-to-load-assets-through-loader/)的介绍你应该知道，Loader 就是负责完成项目中各种各样资源模块的加载，从而实现整体项目的模块化，而 Plugin 则是用来解决项目中除了资源模块打包以外的其他自动化工作，所以说 Plugin 的能力范围更广，用途自然也就更多。
...
![webpackPlugin1](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/zce/webpackPlugin1.png)
...
![webpackPlugin2](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/zce/webpackPlugin2.png)
...
![webpackPlugin3](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/zce/webpackPlugin3.png)
...
![webpackPlugin4](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/zce/webpackPlugin4.png)
...
![webpackPlugin5](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/zce/webpackPlugin5.png)
...
![webpackPlugin6](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/zce/webpackPlugin6.png)
...
例如，我想要压缩输出的图片，我会搜索 *imagemin webpack plugin*。

![搜索结果](https://interview-aliyun.oss-cn-beijing.aliyuncs.com/zce/search-results.png)
